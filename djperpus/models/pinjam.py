...
class Pinjam(models.Model):
    ...
    denda= fields.Integer(string='Penalty', default=0 , compute="_compute_denda")
...
class DetailPinjam(models.Model):
    ...
    member_id = fields.Many2one(comodel_name='djperpus.member', string='member', ondelete="cascade")
    ...
    def _check_qty(self):
        ...
        print("+++++++++++>>>>>>",c.total_pinjem)
        if b.total_hold+c.total_pinjem> b.limit :
